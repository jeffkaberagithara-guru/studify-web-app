            ...
            <div className="lg:max-w-lg">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <Link
                  ...
                  className="px-8 py-3 text-center text-white bg-linear-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
                  Start Learning Free
                </Link>
                ...
                <Link
                  to="/how-it-works"
                  className="px-8 py-3 text-center text-cyan-600 dark:text-cyan-400 border-2 border-cyan-200 dark:border-cyan-800 hover:border-cyan-300 dark:hover:border-cyan-600 rounded-lg font-semibold transition-colors duration-300"
                >
                  See How It Works
                </Link>
              </div>
